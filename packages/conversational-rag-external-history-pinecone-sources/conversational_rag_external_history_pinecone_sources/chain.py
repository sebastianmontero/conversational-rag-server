...
from langchain_core.runnables import RunnableParallel, RunnablePassthrough, RunnableMap, ConfigurableField, RunnableGenerator
...
async def extract_sources(chunks: AsyncIterator[AddableDict]) -> AsyncIterator[AddableDict]:
...
chain = contextualize_chain | RunnableParallel({"context": retriever, "question": RunnablePassthrough()}).assign(answer=answer_chain) | RunnableGenerator(extract_sources)
